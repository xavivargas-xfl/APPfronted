...
const formInicial = {ci:"",nombre:"",apellido:"",sexo:"",nacionalidad:"",fechaNac:"",foto:"",rol:"j"};
                                            ...
                                            <span class="text-secondary font-weight-bold float-left">DATOS PERSONALES</span>
                                                <table className="col-md-12">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="border-bottom border-dark" >
                                                        <input value={form.foto} onChange={handleChange} type="file" className="form-control form-control-sm border-0" name="foto" id="foto" placeholder="Seleccione un imagen" onBlur={handleBlur} required></input>
